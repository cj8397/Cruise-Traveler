                ...
                <?php else: ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <a href="<?php echo e(url('/logout')); ?>"><i
                                        class="glyphicon glyphicon-circle-arrow-left"></i>Logout</a>
                            </li>
                            <?php if (Auth::user()->isAdmin()): ?>
                                <li>
                                    <a href="<?php echo e(url('/admin/home')); ?>"><i
                                            class="glyphicon glyphicon-circle-arrow-left"></i>Admin</a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>

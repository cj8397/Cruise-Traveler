...
<head>
    ...
    <!-- custom theme -->
    <?php /*<link rel="stylesheet" href="<?php echo e(URL::asset('styles/bootstrap.css')); ?>" />*/ ?>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(URL::asset('styles/scrolling-nav.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('styles/custom/nav.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(URL::asset('styles/custom/bootstrap-datetimepicker.min.css')); ?>"/>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php else: ?>
                    ...
                    <ul class="dropdown-menu" role="menu">*/ ?>
                            ...
                            <li>
                                <a href="<?php echo e(url('/logout')); ?>"><i class="glyphicon glyphicon-circle-arrow-left"></i>Logout</a>
                            </li>
                            <?php if(Auth::user()->isAdmin()): ?>
                              <li>
                                  <a href="<?php echo e(url('/admin/home')); ?>"><i class="glyphicon glyphicon-circle-arrow-left"></i>Admin</a>
                              </li>
                            <?php endif; ?>
                            <?php /*</ul>*/ ?>
                    </li>
...
<?php /*<script type="text/javascript" src="<?php echo e(URL::asset('scripts/bootstrap.js')); ?>"></script>*/ ?>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('scripts/jquery.easing.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('scripts/scrolling-nav.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('scripts/moment-with-locales.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('scripts/bootstrap-datetimepicker.min.js')); ?>"></script>

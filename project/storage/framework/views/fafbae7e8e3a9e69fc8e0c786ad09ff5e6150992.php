        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('events/form/post')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="title" value="<?php echo e(old('email')); ?>">

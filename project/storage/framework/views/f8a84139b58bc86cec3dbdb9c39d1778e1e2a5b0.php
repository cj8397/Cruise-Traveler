        ...
        <div class="panel panel-default row col-md-3 col-xs-12">
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div id="credits" class="well hidden col-md-12 col-xs-12">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><h4>Date of Birth: </h4><?php echo e(Auth::user()->dob); ?></li>
                        <li class="list-group-item"><h4>Country: </h4><?php echo e(Auth::user()->country); ?></li>
                        <li class="list-group-item"><h4>Language: </h4><?php echo e(Auth::user()->language); ?></li>
                    ...
                    <div class="row col-md-12 col-xs-12">
                        ...
                        <div class="panel-body col-md-6 col-xs-12">
                            ...
                            <?php foreach($userevents->where('sailing_id',$sailing->sailing->id) as $events): ?>
                                <?php /*<?php if($events != null): ?>*/ ?>
                                    <?php /*<?php foreach($eventdetails[$events->event_id] as $edetail): ?>*/ ?>
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <h5>Event: <a
                                                        href="/events/detail/<?php echo $events->event->id; ?>"><?php echo $events->event->title; ?></a>
                                            </h5>
                                        </li>
                                        <li class="list-group-item">
                                            <strong>Role:</strong><br>
                                            <?php if($events->role == "host"): ?>
                                                <span class="label label-pill label-warning"><?php echo $events->role; ?></span>
                                            <?php else: ?>
                                                <span class="label label-pill label-danger"><?php echo $events->role; ?></span>
                                            <?php endif; ?>
                                        </li>
                                        <li class="list-group-item">
                                ...
                                <?php /*<?php else: ?>*/ ?>
                                <?php /*<span class="label label-pill label-default">You are not participating in any events for this sailing... =(</span>*/ ?>
                                <?php /*<?php endif; ?>*/ ?>
                            <?php endforeach; ?>
